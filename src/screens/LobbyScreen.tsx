...
export function LobbyScreen({ gameId }: LobbyScreenProps) {
  return (
    <div className="min-h-screen bg-slate-100 dark:bg-slate-900 text-slate-900 dark:text-white flex items-center justify-center p-4">
      <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-2xl w-full max-w-md border border-slate-300 dark:border-slate-700 text-center">
        ...
        <p className="text-slate-500 dark:text-slate-400 mb-6">
          Copy the link below and send it to your opponent to start playing.
        </p>

        <InviteLink gameId={gameId} />

        <div className="flex items-center justify-center gap-2 text-slate-400 dark:text-slate-500 animate-pulse">
